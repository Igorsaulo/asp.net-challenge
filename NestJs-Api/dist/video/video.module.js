...
const video_utils_1 = require("./utils/video_utils");
let VideoModule = class VideoModule {
};
exports.VideoModule = VideoModule;
exports.VideoModule = VideoModule = __decorate([
    (0, common_1.Module)({
        providers: [video_service_1.VideoService, video_utils_1.VideoUtils],
        controllers: [video_controller_1.VideoController],
        exports: [video_service_1.VideoService, video_utils_1.VideoUtils],
    })
], VideoModule);
